...
:phpmyadmin_doc_url: https://docs.phpmyadmin.net/en/latest/setup.html#quick-install
...
You may want to install the latest version of phpmyadmin as the OS default versions lacks behind
the latest stable version a lot. {phpmyadmin_latest_url}[Download] the latest version and follow
the {phpmyadmin_doc_url}[documentaion guide] to install it.
